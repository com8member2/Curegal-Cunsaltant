...
class DocumentUploadScreen extends HookWidget {
  @override
                ...
                child: Padding(
                  ...
                  child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(decoration: textFieldDecoration(tr(context).document_number_hint, context),),
                    ),
                    Text("${tr(context).maxSize} 3mb",style: commonTextStyle(context, 14,FontWeight.normal,Colors.red),),
                    Padding(
                            ...
                            child:  Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          tr(context).select_document_text,
                                       ...
                                       Padding(
                                         ...
                                         child: CustomButton(
                                          ...
                                          CustomColor.primaryPurple,
                                           ...
                                           Navigator.of(context).pop();
                                          //documentsUploadNotifier.getImageFromGallery(context);
                    ...
                    Text(tr(context).example,style: commonTextStyle(context, 14,FontWeight.normal,Colors.red),),
                    Padding(
                      padding: const EdgeInsets.only(top:5.0),
                      child: CustomImageView(height:90,width:150,imagePath: "assets/images/doctor.png",fit: BoxFit.fitWidth,),
                    )
                ...
                child: Container(
                    ...
                    child: CommonBottomAlignWidget(
                      setBottomWidget: CustomButton(
                          CustomColor.white, CustomColor.primaryPurple, tr(context).submit, () async {}, 10, 1, MediaQuery.of(context).size.width),
                    ))),
          ],
        ),
      ),
